...
from omnivoice.cli.project_studio_plus import (
    build_demo,
    build_fixed_generate_demo,
    build_preview_demo,
)
...
def test_fixed_generate_panel_builds(tmp_path: Path):
    pytest.importorskip("gradio")
    demo = build_fixed_generate_demo(FakeModel(), tmp_path / "studio")
