...
"""Project Studio launcher with Text Doctor as the first workflow step."""
...
from omnivoice.cli.project_studio_live import build_demo as build_live_project_studio
...
def build_demo(model, workspace: str | Path):
    ...
    studio = build_live_project_studio(model, workspace)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Launch OmniVoice Project Studio with Text Doctor"
    )
