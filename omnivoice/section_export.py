...
"""Export generated Project Studio audio without mutating source artifacts."""
...
def create_project_audio_archive(project: OmniVoiceProject) -> ProjectAudioArchiveResult:
    """Bundle generated section audio directly into one ZIP.

    This path does not merge or re-encode audio. Files are included in manifest
    order with their original bytes. Missing sections are reported as skipped so
    a partially rendered project can still be downloaded.
    """
